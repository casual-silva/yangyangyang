...
def fetch_wx_union_id(user_id):
    t = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2OTQ0NzgwMTAsIm5iZiI6MTY2MzM3NTgxMCwiaWF0IjoxNjYzMzc0MDEwLCJqdGkiOiJDTTpjYXRfbWF0Y2g6bHQxMjM0NTYiLCJvcGVuX2lkIjoiIiwidWlkIjo0ODUwNDY1MCwiZGVidWciOiIiLCJsYW5nIjoiIn0.IEjNoHJiJPqlh86DqDS3-SMTwErTCatQF6ykZk4o-Yc"
    url = f"https://cat-match.easygame2021.com/sheep/v1/game/user_info?uid={user_id}&t={t}"
    response = requests.get(url, headers=headers, verify=False)
    wx_union_id = response.json()['data']['wx_union_id']
    return wx_union_id
...
if __name__ == '__main__':
    YangYang('0210201', count=9999).go_pass()